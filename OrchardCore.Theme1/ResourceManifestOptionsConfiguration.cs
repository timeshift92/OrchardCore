...
namespace OrchardCore.Theme1
{
    public class ResourceManagementOptionsConfiguration : IConfigureOptions<ResourceManagementOptions>
    {
        ...
        public void ResourceManifest()
        {
            _manifest = new ResourceManifest();

            _manifest
                .DefineScript("OrchardCore.Theme1-vendor-jQuery")
                .SetUrl("~/OrchardCore.Theme1/vendor/jquery/jquery.min.js", "~/OrchardCore.Theme1/vendor/jquery/jquery.js")
            ...
            _manifest
                .DefineScript("OrchardCore.Theme1-vendor-jQuery.slim")
                .SetUrl("~/OrchardCore.Theme1/vendor/jquery/jquery.slim.min.js", "~/OrchardCore.Theme1/vendor/jquery/jquery.slim.js")
            ...
            _manifest
                .DefineScript("OrchardCore.Theme1-vendor-jQuery.easing")
                .SetDependencies("OrchardCore.Theme1-vendor-jQuery")
                .SetUrl("~/OrchardCore.Theme1/vendor/jquery-easing/jquery.easing.min.js", "~/OrchardCore.Theme1/vendor/jquery-easing/jquery.easing.js")
            ...
            _manifest
                .DefineScript("OrchardCore.Theme1-vendor-bootstrap")
                .SetDependencies("OrchardCore.Theme1-vendor-jQuery")
                .SetUrl("~/OrchardCore.Theme1/vendor/bootstrap/js/bootstrap.min.js", "~/OrchardCore.Theme1/vendor/bootstrap/js/bootstrap.js")
            ...
            _manifest
                .DefineScript("OrchardCore.Theme1-vendor-bootstrap-bundle")
                .SetDependencies("OrchardCore.Theme1-vendor-jQuery")
                .SetUrl("~/OrchardCore.Theme1/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/OrchardCore.Theme1/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            _manifest
                .DefineStyle("OrchardCore.Theme1-vendor-bootstrap")
                .SetUrl("~/OrchardCore.Theme1/vendor/bootstrap/css/bootstrap.min.css", "~/OrchardCore.Theme1/vendor/bootstrap/css/bootstrap.css")
            ...
            _manifest
                .DefineStyle("OrchardCore.Theme1-bootstrap-oc")
                .SetUrl("~/OrchardCore.Theme1/css/bootstrap-oc.min.css", "~/OrchardCore.Theme1/css/bootstrap-oc.css")
                .SetVersion("1.0.0");

            _manifest
                .DefineStyle("OrchardCore.Theme1-vendor-font-awesome")
                .SetUrl("~/OrchardCore.Theme1/vendor/fontawesome-free/css/all.min.css", "~/OrchardCore.Theme1/vendor/fontawesome-free/css/all.css")
            ...
            _manifest
                .DefineScript("OrchardCore.Theme1-vendor-font-awesome")
